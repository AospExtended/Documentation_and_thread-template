...
[B][SIZE="4"][COLOR="Black"]AOSP Extended is an AOSP based ROM which provides stock UI/UX experience with useful customizations. Being based on AOSP it provides a smooth experience. We have added useful customizations from various other open-source projects and have tried to keep our things simple. A ROM by a user, for a user. #BeExtended[/COLOR][/SIZE][/B]
...
Checkout our [URL="https://github.com/aospextended"][COLOR="Red"]Github[/COLOR][/URL] and [URL="http://gerrit.aospextended.com/"][COLOR="Red"]Gerrit[/COLOR][/URL] [/B][/SIZE]
...
->We recommend [URL="https://forum.xda-developers.com/apps/magisk/official-magisk-v7-universal-systemless-t3473445"]Magisk[/URL]
 ...
 -[COLOR="Red"]Does this ROM Support Substratum?[/COLOR]
...
-[COLOR="Red"]What about XPOSED?[/COLOR]
